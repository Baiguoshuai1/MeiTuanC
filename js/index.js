...
$(function(){
	$(".left-banner-container-lie li").each(function(){	
		$(this).hover(function(){//循环显示分类的列表效果
			...
			$(".left-banner-container-content").stop().fadeIn(180);
			...
			$(".left-banner-container-content").stop().fadeOut(180);
		})
	})
	...
	$(".slider").hover(function(){
		...
		$(".login_blank").click(function(){		//登录 为了跳转页面
			$.cookie("back-html","index.html",{path:"/"})//先存储网页地址，跳到登陆页面再存储用户名
		})
		$(".registe_blank").click(function(){		//注册
			$.cookie("back-html","index.html",{path:"/"})
		})
